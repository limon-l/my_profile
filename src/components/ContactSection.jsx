      ...
      <div className="container">
        ...
        <div className="contact-grid max-w-5xl mx-auto">
          ...
          <ScrollReveal delay={100}>
            <div className="glass-card contact-panel p-8 h-full">
              ...
              <div className="space-y-3">
                {[
                  ...
                  return (
                    <Tag key={idx} href={contact.link || undefined} className="contact-link block p-4 rounded-xl bg-[var(--surface-1)] border border-[var(--border-subtle)]">
          ...
          <ScrollReveal delay={200} animation="reveal-right">
            <div className="glass-card contact-panel contact-form-panel p-8">
              <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
                <span className="w-10 h-10 rounded-xl bg-[var(--accent-soft)] flex items-center justify-center text-[var(--accent)]">
              ...
              <form ref={formRef} onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="absolute opacity-0 h-0 overflow-hidden" tabIndex="-1" aria-hidden="true">
                  ...
                  <input type="text" name="website" id="website" value={formData.website || ""} onChange={handleFormChange} tabIndex="-1" autoComplete="off" />
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="form-group">
                    <input id="name" type="text" name="name" value={formData.name} onChange={handleFormChange} placeholder=" " required aria-label="Full Name" className="form-input" />
                    <label htmlFor="name" className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5 uppercase tracking-[0.05em]">Full Name</label>
                  </div>
                  <div className="form-group">
                    <input id="email" type="email" name="email" value={formData.email} onChange={handleFormChange} placeholder=" " required aria-label="Email Address" className="form-input" />
                    <label htmlFor="email" className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5 uppercase tracking-[0.05em]">Email Address</label>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="form-group">
                    <input id="company" type="text" name="company" value={formData.company || ""} onChange={handleFormChange} placeholder=" " aria-label="Company" className="form-input" />
                    <label htmlFor="company" className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5 uppercase tracking-[0.05em]">Company</label>
                  </div>
                  <div className="form-group">
                    <input id="country" type="text" name="country" value={formData.country || ""} onChange={handleFormChange} placeholder=" " aria-label="Country" className="form-input" />
                    <label htmlFor="country" className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5 uppercase tracking-[0.05em]">Country</label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="form-group">
                    ...
                    <select id="budget" name="budget" value={formData.budget || ""} onChange={handleFormChange} className="form-input form-select" aria-label="Budget Range">
                  ...
                  <div className="form-group">
                    ...
                    <select id="projectType" name="projectType" value={formData.projectType || ""} onChange={handleFormChange} className="form-input form-select" aria-label="Project Type">
                ...
                <div className="form-group">
                  ...
                  <select id="timeline" name="timeline" value={formData.timeline || ""} onChange={handleFormChange} className="form-input form-select" aria-label="Project Timeline">
                ...
                <div className="form-group">
                  <textarea id="message" name="message" value={formData.message} onChange={handleFormChange} rows="5" placeholder=" " required aria-label="Message" className="form-input resize-none min-h-[140px]" />
                  <label htmlFor="message" className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5 uppercase tracking-[0.05em]">Your Message</label>
                </div>

                {/* File attachment */}
                <div className="form-group">
                  <label htmlFor="attachment" className="block text-xs text-[var(--text-muted)] mb-2 font-medium">
                    <i className="fas fa-paperclip mr-1.5 text-[var(--accent)] opacity-50"></i>
                    Attachment (optional)
                  </label>
                  <input id="attachment" type="file" name="attachment" accept=".pdf,.doc,.docx,.txt,.png,.jpg,.jpeg" aria-label="Attach a file" className="attachment-input block w-full text-sm text-[var(--text-muted)] file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-[var(--accent-soft)] file:text-[var(--accent)] file:cursor-pointer" />
